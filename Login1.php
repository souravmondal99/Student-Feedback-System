...
<body>
  ...
  <div class="wrapper-style4">
    <header class="align-center">
      <h2 style="color:white; margin-top: 40px; font-size: 40px">Student Login/ Register </h2>
    </header>
  </div>
    ...
    <div class="main-div">
      <div class="panel panel-default" style="padding: 50px 20px">
        ...
        <form id="signup" method="post">
          ...
          <span>New Student?</span> <a href="Registration1.php" style="color:#00ffe7;">Register here</a>
