                ...
                <div class="col-lg-12">
                    ...
                    if ($info != "") {
                        ...
                        ?>
                          ...
                          <h1 class="page-header" style="text-align: center;">Welcome to Admin Dashboard</h1>
                
                          <table class="table table-striped" style="min-height: 256px;text-align: center;">
                            <tbody>
                              <tr style="font-size: 20px;">
                                <th scope="col" style="text-align: center;">Total Number of Faculty :</th>
                            ...
                            <tbody>
                              <tr>
                                <td> <?php
                                      ...
                                      echo "<h2 style='color:green'> $rows</h2>";
