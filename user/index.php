    ...
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        ?>
          ...
          <h1 class="page-header" style="text-align: center;">Welcome to Student Dashboard</h1>

          <table class="table table-striped" style="min-height: 256px;text-align: center;">
            <tbody>
              <tr style="font-size: 20px;">
                <th scope="col" style="text-align: center;">Your Stream:</th>
            ...
            <tbody>
              <tr>
                <td> <?php
                      ...
                      echo "<h2 style='color:green'>  $users[programme]</h2>";
